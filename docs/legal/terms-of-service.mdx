...
description: "Terms and conditions for using Resume Craft, including accounts, public resumes, uploads, and exports."
---

## Agreement

These Terms of Service (the “Terms”) govern your access to and use of **Resume Craft** (the “Service”). By using the Service, you agree to these Terms.

- **Service Operator**: Amruth Pillai
- **Contact**: hello@amruthpillai.com
- **Service URL**: https://Resume-Craft.vercel.app
- **Effective date**: 2023-01-01

If you do not agree, do not use the Service.

<Note>
  Replace the placeholders above with the correct operator details for your deployment. If you are using the official hosted service at <code>Resume-Craft.vercel.app</code>, the project's published support contact is <code>hello@amruthpillai.com</code>.
</Note>
...
Resume Craft is a resume builder that allows you to create, store, and share resumes, upload related assets, and export/print resumes (including generating PDFs and screenshots).
...
Resume Craft is open-source software licensed under the **MIT License**. These Terms govern **use of the Service**, not the open-source license for the code.
