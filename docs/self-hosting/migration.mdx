...
description: "A step-by-step guide to migrate your Resume Craft instance from v4 to v5, including manual and automated migration options."
---

## Overview

This guide walks you through migrating your Resume Craft installation from **v4 to v5**. The migration process involves setting up a new v5 instance alongside your existing v4 instance, then transferring your users and resumes to the new system.
...
<CardGroup cols={2}>
  <Card title="Running v4 Instance">
    Your existing Resume Craft v4 instance should be running and accessible.
  </Card>
  <Card title="New v5 Instance">
    A fresh Resume Craft v5 instance set up and running. Follow the [Self-Hosting with Docker](/self-hosting/docker) guide if you haven't done this yet.
  </Card>
...
<Steps>
  ...
  <Step title="Import into v5">
    ...
    3. Select the **Resume Craft v4** format
...
<CardGroup cols={1}>
  ...
  <Card title="Resume Craft Source Code">
    Clone the Resume Craft repository to access the migration scripts:
    ```bash
