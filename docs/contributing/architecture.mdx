...
description: "Understand the architecture and codebase structure of Resume Craft"
---

This guide provides a comprehensive overview of Resume Craft's architecture and codebase structure, helping you understand how different parts of the application work together.

---

## Tech Stack Overview

Resume Craft is built with a modern, type-safe stack:
...
**Diagram:** This flow shows data and control flow between the main architectural layers of Resume Craft.
...
Resume Craft uses a hybrid approach:
...
<CardGroup cols={2}>
  <Card
    ...
    icon="comments"
    href="https://github.com/amruthpillai/Resume-Craft/discussions"
  >
