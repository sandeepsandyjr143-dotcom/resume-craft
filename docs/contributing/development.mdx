...
description: "Set up a local development environment for Resume Craft"
---
...
This guide walks you through setting up Resume Craft for local development. Whether you're contributing to the project or customizing it for your needs, these steps will get you up and running.
...
<Steps>
  ...
  <Step title="Start the Development Server">
    ...
    Your local Resume Craft instance will be available at [http://localhost:3000](http://localhost:3000).
  </Step>
</Steps>
...
Resume Craft uses [Lingui](https://lingui.dev/) for internationalization.
...
// For JSX content
<Trans>Welcome to Resume Craft</Trans>
```
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="github"
    href="https://github.com/amruthpillai/Resume-Craft"
  >
