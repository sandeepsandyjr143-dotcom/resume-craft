---
title: "Introduction"
description: "Welcome to the documentation for Resume Craft, a free and open-source resume builder that simplifies the process of creating, updating, and sharing your resume."
---

<Frame>
  <img src="/images/getting-started/banner.webp" alt="Resume Craft Banner"  />
</Frame>

## What is Resume Craft?

**Resume Craft** is a free and open-source resume builder designed to simplify the process of creating, updating, and sharing your professional resume. Built with privacy as a core principle, it gives you complete control over your data while providing a powerful, modern experience.
...
<Frame>
  <img src="/images/getting-started/infographic.webp" alt="An infographic of the major features of Resume Craft" />
</Frame>

<AccordionGroup>
  <Accordion title="Completely Free & Open Source" icon="code-branch">
    Resume Craft is licensed under MIT. You can use it for free, modify it, and even host your own instance. The entire codebase is available on [GitHub](https://github.com/amruthpillai/Resume-Craft).
  </Accordion>
  ...
  <Accordion title="Multi-language Support" icon="globe">
    Resume Craft supports multiple languages, making it accessible to users worldwide. Contribute translations to help us reach more people.
  </Accordion>
  ...
  <Accordion title="Self-hosting Ready" icon="server">
    Deploy your own instance of Resume Craft using Docker. Keep complete control over your data and infrastructure.
  </Accordion>
</AccordionGroup>

## Getting Started

Whether you want to use our hosted version or run your own instance, Resume Craft has got you covered.
...
<CardGroup cols={2}>
  ...
  >
    Set up a local development environment to contribute or customize Resume Craft.
  </Card>
</CardGroup>

## Tech Stack

Resume Craft is built with modern web technologies:
...
<CardGroup cols={2}>
  <Card title="GitHub" icon="github" href="https://github.com/amruthpillai/Resume-Craft">
  ...
  <Card title="Sponsor" icon="heart" href="https://opencollective.com/Resume-Craft">
    Support the development and long-term sustainability of Resume Craft.
  </Card>
</CardGroup>
