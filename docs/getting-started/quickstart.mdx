---
title: "Quickstart"
description: "Get started with Resume Craft in minutes — use our hosted version or deploy your own instance"
---

## Options

Resume Craft offers flexibility in how you want to use it. Choose the option that best fits your needs:
...
The easiest way to use Resume Craft is through our cloud version at [Resume-Craft.vercel.app](https://Resume-Craft.vercel.app). **This service is completely free and will always remain free.**

<Steps>
  <Step title="Create an Account">
    Visit [Resume-Craft.vercel.app](https://Resume-Craft.vercel.app) and sign up for free using your email, or sign in with your GitHub or Google account.
  </Step>
...
For users who prefer complete control over their data, you can deploy Resume Craft on your own infrastructure using Docker.
...
<Steps>
  ...
  <Step title="Start the Services">
    ...
    - **Resume Craft** — The main application
  </Step>
  
  <Step title="Access Your Instance">
    Once all services are running, access your Resume Craft instance at:
...
| `app` | 3000 | The main Resume Craft application |
...
| `APP_URL` | Public URL of your Application | `https://Resume-Craft.vercel.app` |
...
<CardGroup cols={2}>
  ...
  >
    Set up a development environment to contribute or customize Resume Craft.
  </Card>
  <Card
...
<Note>
  **Having trouble?** Check our [GitHub Issues](https://github.com/amruthpillai/Resume-Craft/issues) or reach out via [email](mailto:hello@amruthpillai.com).
</Note>
