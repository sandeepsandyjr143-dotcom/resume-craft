...
description: "Learn how to create your first resume in Resume Craft, set a name and slug, and open it in the builder."
---

<Steps>
  <Step title="Log in to your account">
    Head over to [https://Resume-Craft.vercel.app](https://Resume-Craft.vercel.app) and log in with your account credentials.
  ...
  <Step title="Review (or edit) the slug">
    ...
    <Warning>
      If you choose to publicly share your resume, it will be accessible at `https://Resume-Craft.vercel.app/{username}/{slug}`.
    </Warning>
  </Step>
