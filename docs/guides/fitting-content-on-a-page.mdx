...
When your resume content overflows the page, Resume Craft displays a warning just below the page. This guide explains how to reorganize and adjust your content so everything fits within your chosen page format.
...
<Warning>
  While Resume Craft supports multi-page resumes, each page has a fixed height based on your chosen format (A4 or Letter). If a single page's content exceeds this height, parts of your resume may be rendered improperly when printed or exported.
</Warning>
