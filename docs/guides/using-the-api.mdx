---
title: "Using the API"
description: "Learn how to create API keys and authenticate requests to the Resume Craft API"
---
...
<Steps>
  ...
  <Step title="Open the API reference">
    ...
    <Tip>
      You can also open it directly here: [API Reference](https://docs.Resume-Craft.vercel.app/api-reference).
    </Tip>
  </Step>
  ...
  <Step title="Authenticate requests with x-api-key">
    ...
    <Info>
      If you're self-hosting, replace <code>https://Resume-Craft.vercel.app</code> with your instance URL. The API is served under <code>/api/openapi</code>.
    </Info>

    ```bash
    curl "https://Resume-Craft.vercel.app/api/openapi/resume/list" \
