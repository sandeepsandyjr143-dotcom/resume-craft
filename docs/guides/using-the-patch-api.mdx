...
<Info>
  If you're self-hosting, replace `https://Resume-Craft.vercel.app` with your instance URL. The API is served under `/api/openapi`.
</Info>
...
```bash
curl -X PATCH "https://Resume-Craft.vercel.app/api/openapi/resume/YOUR_RESUME_ID" \
