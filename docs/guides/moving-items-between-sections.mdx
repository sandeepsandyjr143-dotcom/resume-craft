...
<Steps>
  ...
  <Step title="Select a destination">
    ...
    <Tip>
      If a custom section of the same type doesn't exist on your target page, Resume Craft will **automatically create one** for you. This makes it easy to split sections across pages without manual setup.
    </Tip>
  </Step>
