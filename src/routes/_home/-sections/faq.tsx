...
const crowdinUrl = "https://crowdin.com/project/Resume-Craft";
...
const getFaqItems = (): FAQItemData[] => [
	{
		question: t`Is Resume Craft really free?`,
		answer: t`Yes! Resume Craft is completely free to use, with no hidden costs, premium tiers, or subscription fees. It's open-source and will always remain free.`,
	},
	{
		question: t`How is my data protected?`,
		answer: t`Your data is stored securely and is never shared with third parties. You can also self-host Resume Craft on your own servers for complete control over your data.`,
	},
	{
	...
	{
		question: t`Is Resume Craft available in multiple languages?`,
		answer: (
			<Trans>
				Yes, Resume Craft is available in multiple languages. You can choose your preferred language in the settings
	...
	{
		question: t`What makes Resume Craft different from other resume builders?`,
		answer: t`Resume Craft is open-source, privacy-focused, and completely free. Unlike other resume builders, it doesn't show ads, track your data, or limit your features behind a paywall.`,
	},
	{
