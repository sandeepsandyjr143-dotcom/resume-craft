		...
		<SectionBase type="information" className="space-y-4">
			<div className="space-y-2 rounded-md border bg-sky-600 p-5 text-white dark:bg-sky-700">
				...
				<div className="space-y-2 text-xs leading-normal">
					<Trans>
						<p>
							Thank you for using Resume Craft! This app is a labor of love, created mostly in my spare time, with
							wonderful support from open-source contributors around the world.
						</p>
						<p>
							If Resume Craft has been helpful to you, and you'd like to help keep it free and open for everyone,
				...
				<Button asChild size="sm" variant="default" className="mt-2 whitespace-normal px-4! text-xs">
					<a href="http://opencollective.com/Resume-Craft" target="_blank" rel="noopener">
						<HandHeartIcon />
						<span className="truncate">
							<Trans>Donate to Resume Craft</Trans>
						</span>
					</a>
				</Button>
			</div>
			...
			<div className="flex flex-wrap gap-0.5">
				...
				<Button asChild size="sm" variant="link" className="text-xs">
					<a href="https://github.com/amruthpillai/Resume-Craft" target="_blank" rel="noopener">
						<Trans>Source Code</Trans>
					</a>
				</Button>

				<Button asChild size="sm" variant="link" className="text-xs">
					<a href="https://github.com/amruthpillai/Resume-Craft/issues" target="_blank" rel="noopener">
